...
8. Additionally, set the **Data Type** as _CHAR_.
...
> **Note: String vs. Character Data Types**
>
> When defining data elements in ABAP Dictionary, you can choose between `STRING` (variable-length) and `CHAR` (fixed-length) data types:
>
> - **STRING**: A variable-length character type stored as LOB (Large Object) in SAP HANA. Suitable for text fields where the length can vary significantly (for example, descriptions or notes). However, **STRING** fields have important limitations:
>   - They cannot be used as key fields in database tables.
>   - They cannot be used with `CONTAINS` search predicates in OData filter operations without a fuzzy search index.
>   - They may cause runtime errors like: *"feature not supported: CONTAINS predicates on LOB or BINARY column without fuzzy search index"*.
>
> - **CHAR**: A fixed-length character type with a defined maximum length (up to 1333 characters). Recommended for fields that:
>   - Need to be used as keys or in WHERE clauses
>   - Require filtering, sorting, or search operations in OData or SAP Fiori apps
>   - Need better compatibility with database operations
>
> **When to use which:**
> | Use Case | Recommended Type |
> | :------- | :--------------- |
> | Name, title, email (searchable fields) | CHAR |
> | Long descriptions, notes, comments | STRING |
...
For more information on associations, see [Association](./90-Core-Data-Services.md#associations).
...
| :------------------------------- | :------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|                                  | Data Definition      | [ZPRA_MF_I_Visit_Status_VH](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_i_visit_status_vh.ddls.asddls) <br> [ZPRA_MF_I_Visitor](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_i_visitor.ddls.asddls) <br>[ZPRA_MF_R_VISIT](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_r_visit.ddls.asddls)<br>[ZPRA_MF_C_VISITTP](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_c_visittp.ddls.asddls) |
|                                  |                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Calculation class Annotation     | Data Definition      | Adjustment needed to add calculated class in Data Definition [ZPRA_MF_C_MusicFestivalTP](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_c_musicfestivaltp.ddls.asddls)                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Calculation class Implementation | Source Code Library  | [zcl_pra_mf_calc_visit_elements](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zcl_pra_mf_calc_visit_elements.clas.abap)                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|                                  | Behaviour definition | Adjustment needed to add Visit in Music Behaviour definition [ZPRA_MF_R_MusicFestival](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_r_musicfestival.bdef.asbdef)                                                                                                                                                                                                                                                                                                                                                                                                                        |
|                                  | Behaviour definition | Draft table generation using Quick Assist view in [ZPRA_MF_R_MusicFestival](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_r_musicfestival.bdef.asbdef)<br> Adjustments in Music Projection Behaviour View [ZPRA_MF_C_MusicFestivalTP](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_c_musicfestivaltp.bdef.asbdef)                                                                                                                                                                                                        |
| Business Service                 |                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|                                  | Service Definition   | Adjustment in Service Definition [ZPRA_MF_MusicFestival](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_musicfestival.srvd.srvdsrv)<br> [ZPRA_MF_VISITOR](https://github.com/SAP-samples/abap-partner-reference-application/blob/main/src/zpra_mf_service/zpra_mf_visitor.srvd.srvdsrv)                                                                                                                                                                                                                                                                                              |

For more information on the artifacts mentioned above, see [Core Data Services](./90-Core-Data-Services.md).
...
3. The app runs in _Preview_ mode in a local system to test.
