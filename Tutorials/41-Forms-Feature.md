...
12. Create a util class called [zcl_pra_mf_form_util](../src/zpra_mf_service/zcl_pra_mf_form_util.clas.abap) by right-clicking on **Source Code Library** and choosing **New ABAP Class** to process the forms in SAP Forms service. We use the PDF generation service with the **CL_FP_FDP_SERVICES** class.
