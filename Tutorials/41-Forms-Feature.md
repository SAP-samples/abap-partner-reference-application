...
14. For the **OutputPdfData**  virtual element, add the UUID to extract the event details in the ** if_sadl_exit_calc_element_read~get_calculation_info** method of the [calculated class](objects/CLAS/ZCL_PRA_MF_CALC_MF_ELEMENTS).
...
Now, take a comprehensive tour through the Forms feature of *Music Festival Manager* to see how PDF documents are generated for event management:
