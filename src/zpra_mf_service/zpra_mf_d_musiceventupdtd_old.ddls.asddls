@EndUserText.label: 'Abstract Entity for MF Event Updated old'
@Metadata.allowExtensions: true
@ObjectModel.supportedCapabilities: [#DATA_STRUCTURE]
define abstract entity ZPRA_MF_D_MUSICEVENTUPDTD_OLD
{
  ...
  _parent             : association to parent ZPRA_MF_D_MUSICEVENTUPDATED;
}
