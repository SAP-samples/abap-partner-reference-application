...
CLASS ltcl_fp_fdp_glo_itf IMPLEMENTATION.
  ...
  METHOD if_fp_fdp_api~get_keys.
    ...
    rt_keys = VALUE if_fp_fdp_api=>tt_select_keys( ( name = 'UUID' value = 'DEC190889AC21FE08191A45962D04217' data_type = 'CHAR' ) ).
  ...
  METHOD if_fp_fdp_api~read_to_xml_v2.
    ...
    ALL FIELDS WITH CORRESPONDING #( entity_keys )
...
CLASS ltcl_pra_mf_util_form DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.

  PRIVATE SECTION.
    CLASS-DATA:
      cut                  TYPE REF TO zcl_pra_mf_form_util,     " the class to be tested
      cds_test_environment TYPE REF TO if_cds_test_environment.  " cds test double framework

    CONSTANTS:
      application_service_def TYPE if_fp_fdp_api=>ty_service_definition VALUE 'ZPRA_MF_MUSICFESTIVAL',
      form_template           TYPE fpname VALUE 'ZPRA_MF_PDF_FORM_MF',
      uuid                    TYPE sysuuid_x16 VALUE 'DEC190889AC21FE08191A45962D04217',
      min_pdf_size            TYPE i VALUE 190000,
      max_pdf_size            TYPE i VALUE 200000..
    ...
    METHODS:
      ...
      teardown,
      should_get_fp_fdp_api_instance      FOR TESTING,
      should_render_form_for_preview      FOR TESTING,
      reject_invalid_form_name            FOR TESTING,
      reject_invalid_srv_defenition       FOR TESTING.
...
CLASS ltcl_pra_mf_util_form IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    TRY.
        CREATE OBJECT cut.
      CATCH cx_fp_fdp_error INTO DATA(lx_error).
  ...
  METHOD should_render_form_for_preview.
    ...
    DATA: entity_key   TYPE sysuuid_x16,
          mf_mock_data TYPE STANDARD TABLE OF zpra_mf_a_mf.
    ...
    TRY.
        ...
        DATA(pdf) = cut->render_form_for_preview( id              = entity_key
  ...
  METHOD reject_invalid_form_name.
    TRY.
      ...
      CATCH cx_root INTO DATA(unexpected_exception).
        ...
        cl_abap_unit_assert=>fail(
          msg = |Expected exception cx_fp_form_reader did not occur. Unexpected exception of type { cl_abap_typedescr=>describe_by_data( unexpected_exception )->get_relative_name( ) } occurred: { unexpected_exception->get_text( ) }|
        ).
    ENDTRY.
  ENDMETHOD.
  ...
  METHOD reject_invalid_srv_defenition.
    TRY.
      ...
      CATCH cx_root INTO DATA(unexpected_exception).
        " Any other exception should fail the test
        cl_abap_unit_assert=>fail(
          msg = |Expected exception cx_fp_fdp_error did not occur. Unexpected exception of type { cl_abap_typedescr=>describe_by_data( unexpected_exception )->get_relative_name( ) } occurred: { unexpected_exception->get_text( ) }|
        ).
    ENDTRY.
  ENDMETHOD.
  ...
  METHOD should_get_fp_fdp_api_instance.
    TRY.
        ...
        cl_abap_unit_assert=>assert_true(
          act = xsdbool( fp_fdp_service IS INSTANCE OF if_fp_fdp_api )
      ...
      CATCH cx_fp_fdp_error cx_fp_form_reader cx_fp_ads_util INTO DATA(lx_error).
        " Fail the test if exception occurs
        cl_abap_unit_assert=>fail(
          msg = |Exception of type { cl_abap_typedescr=>describe_by_data( lx_error )->get_relative_name( ) } occurred: { lx_error->get_text( ) }|
        ).
    ENDTRY.
  ENDMETHOD.
